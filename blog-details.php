...
<!-- header-end -->
              ...
              <!-- <form role="search" method="get" id="searchform"   class="searchform" action="http://wordpress.zcube.in/xconsulta/">
                    ...
                    <div id="cssmenu2" class="menu-one-page-menu-container">
                        <ul id="menu-one-page-menu-1" class="menu">
                            ...
                            <li class="menu-item menu-item-type-custom menu-item-object-custom"><a href="mailto:7hillsproperties@gmail.com"><span>7hillsproperties@gmail.com</span></a></li>
                        </ul>
                    </div>                
            </div>
		...
		<!-- /search-popup -->
            <!-- breadcrumb-area -->
           <section class="breadcrumb-area d-flex  p-relative align-items-center " style="background-image:url(img/blogdetails/bg11.jpeg);
 background-size: cover; background-position: center; background-repeat: no-repeat;">
                            ...
                            <div class="blog-details-wrap">
                                <div class="details__content pb-30">
                                    ...
                                    <div class="details__content-img">
                                        <img src="img/blogdetails/pexels-gapeppy1-4117878.jpg" alt="">
                                    </div>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt
                                        ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
                                        nisi ut aliquip
                                    ...
                                    <figure>
                                        <img src="img/blogdetails/bg15.jpg" alt="">
                                ...
                                <div class="posts_navigation pt-35 pb-35">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-xl-4 col-md-2 text-left text-md-center">
                                            <a href="blog.php" class="blog-filter"><img src="img/icon/c_d01.png" alt=""></a>
                                        </div>
                                        <div class="col-xl-4 col-md-5">
                                ...
                                <div class="related__post mt-45 mb-85">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="related-post-wrap mb-30">
                                                <div class="post-thumb">
                                                    <img src="img/blogdetails/bg18.png" alt="">
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="related-post-wrap mb-30">
                                                <div class="post-thumb">
                                                    <img src="img/blogdetails/bg19.png" alt="">
                                                </div>
                                                <div class="rp__content">
                                ...
                                <div class="avatar__wrap text-center mb-45">
                                    <div class="avatar-img">
                                        <img src="img/testimonial/testimonial3.jpg" alt="" style="height:100px;width:100px;border-radius:50%;">
                                    </div>
                                ...
                                <div class="comment__wrap pb-45">
                                    ...
                                    <div class="single__comment mb-35">
                                        <div class="comments-avatar">
                                            <img src="img/testimonial/testimonials01.webp" style="height:100px;width:100px;border-radius:50%;" alt="">
                                        </div>
                                    ...
                                    <div class="single__comment children mb-35">
                                        <div class="comments-avatar">
                                            <img src="img/testimonial/testimonial03.jpg" style="height:100px;width:100px;border-radius:50%;" alt="">
                                        </div>
                                        <div class="comment-text">
                                            <div class="avatar-name mb-15">
        ...
        <script>
          var wa_btnSetting = {"btnColor":"#16BE45","ctaText":"WhatsApp","cornerRadius":40,"marginBottom":20,"marginLeft":20,"marginRight":20,"btnPosition":"left","whatsAppNumber":"918296000777","welcomeMessage":"Hello","zIndex":999999,"btnColorScheme":"light"};
          window.onload = () => {
