...
// java script for the blog animation
...
document.addEventListener("DOMContentLoaded", () => {
	...
	const elementsToAnimate = document.querySelectorAll(".single-post2, .blog-thumb2");
...
//  java script for aniamting the cards
document.addEventListener("DOMContentLoaded", () => {
	const observer = new IntersectionObserver((entries, observer) => {
		entries.forEach(entry => {
			if (entry.isIntersecting) {
	...
	const serviceCards = document.querySelectorAll(".services-08-item");
